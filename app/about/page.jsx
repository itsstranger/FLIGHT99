        ...
        <div className="pt-20 min-h-screen bg-white">
            ...
            <section className="relative h-[400px] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    ...
                    <p className="text-xl text-gray-200 max-w-2xl mx-auto">Your trusted partner in global travel for over 25 years.</p>
                </div>
            </section>
            ...
            <section className="py-20 container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-6">
                            Established in 1999, FLIGHT99 has grown from a small ticketing agency to a comprehensive travel management company. With over two decades of industry experience, we specialize in curating seamless travel experiences for leisure and business travelers alike.
                        </p>
                        <p className="text-gray-600 leading-relaxed mb-6">
                            Our commitment to "100% Trustability" and "Genuine Service" isn't just a slogan; it's the foundation of every booking we handle. From complex visa processing to luxury holiday packages, our expert team ensures every detail is perfect.
                        </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        { icon: ShieldCheck, title: "100% Trustability", desc: "We operate with total transparency and integrity in pricing and services." },
