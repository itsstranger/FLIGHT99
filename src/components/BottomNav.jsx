                ...
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isActive && (
                                <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-14 h-14 bg-white rounded-full p-1 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] border-t border-gray-100 flex items-center justify-center z-10">
