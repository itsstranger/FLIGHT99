...
const PackageProvider = ({ children })=>{
    ...
    const updatePackage = async (id, updatedData)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('packages').update(updatedData).eq('id', id);
        if (error) {
...
//# sourceMappingURL=src_9b423feb._.js.map